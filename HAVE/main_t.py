...
import numpy as np
import torch
from data_t import Run



parser = argparse.ArgumentParser()
parser.add_argument('--model_name', default='HAVE', help='HAVE')
...
parser.add_argument('--seed', type=int, default=2024) # 2022
parser.add_argument('--gpu', type=int, required=True)
parser.add_argument('--lr', type=float, default=0.0005) #0.0001
parser.add_argument('--lambd', type=float, default=0.1)
parser.add_argument('--dropout', type=float, default=0.1)
parser.add_argument('--weight_decay', type=float, default=5e-5)##应该增大
